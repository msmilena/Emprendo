...
class EntrepreneurEntityFactory:

    @staticmethod
    def create(id: str|None, name: str, description: str, price: float, stock: int, image: str) -> EntrepreneurEntity:
        if id is None:
            id = uuid.uuid4().__str__()
        return EntrepreneurEntity(id, name, description, float(price), int(stock), image)
