...
def initialize_service():
    ...
    try:
        print("Inicializando el servicio de recomendaciones...")
        recommendation_service = RecommendationService()
        recommendation_service.fetch_data()
        print("Servicio de recomendaciones inicializado correctamente.")
    except Exception as e:
        print(f"Error inicializando el servicio de recomendaciones: {str(e)}")
        recommendation_service = None
...
@main.route('/similar/<string:business_id>', methods=['GET'])
...
def test_route():
    """Ruta de prueba que devuelve un 'Hola Mundo'"""
    return jsonify({
        'success': True,
        'message': 'Hola Mundo'
    })